---
title: "Beyond Spreadsheets: R for the MBAs"
...
TK rewrite more clearly: To change data type, we apply the relevant function, such `as.character` or `as.factor`, to a column and then assign the output of the function (values with changed data type) to the same column. 
...
```
*Discuss: Should we worry about missing values? Why?*
