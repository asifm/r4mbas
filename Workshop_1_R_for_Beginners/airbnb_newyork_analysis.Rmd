...
This is how `filter`, `select`, and such functions receives a dataframe, does something to it, returns the modified dataframe and passes it on to the next function.
