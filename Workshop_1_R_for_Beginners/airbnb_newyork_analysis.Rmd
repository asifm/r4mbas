...
*Exercise: Place the cursor below and create a placeholder for writing code. Now write some code and run the code. For example, find the result of `3543 / 562`.*
...
*Discuss: Is there anything else we need to know about?*
...
The map shows the relative size and location of the five boroughs. 
